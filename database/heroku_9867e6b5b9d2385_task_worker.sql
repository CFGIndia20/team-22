...
CREATE TABLE `task_worker` (
  ...
  `worker_uploaded_l0` int(11) DEFAULT NULL,
  `approved_l1` int(11) DEFAULT NULL,
  `done_l2` int(11) DEFAULT NULL
...
INSERT INTO `task_worker` VALUES (1,1,1,100,0,0,0),(1,2,1,200,0,0,0),(2,3,1,500,0,0,0),(2,4,1,500,0,0,0);
...
-- Dump completed on 2020-07-26 10:40:30
